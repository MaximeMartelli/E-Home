...
class apds9960{
    ...
    public:
     ...
     apds9960(PinName sda, PinName scl);  //constructor
    ~apds9960();

    
#ifdef DEBUG
    Serial *pc;
    bool ginit(Serial &par);
#else
    bool ginit();
#endif
    ...
    /* Raw I2C Commands */
    I2C i2c;
    bool wireWriteDataByte(char reg, uint8_t val);
    bool wireReadDataByte(char reg, uint8_t &val);
    int wireReadDataBlock(char reg, uint8_t *val, unsigned int len);
